...
class LaTeXValidator:
            ...
            if pos in begin_map:
                ...
                if not env_stack:
                    ...
                    if normalized_expected != normalized_actual:
                        ...
                        # Same normalized form but different names (e.g., tightitemize vs itemize)
                        # This is a warning but not a fatal error - will be auto-fixed
                        pass
    ...
    def _check_preamble_display_math(self, source: str) -> Optional[ValidationError]:
        ...
        preamble = source if begin_doc == -1 else source[:begin_doc]
