...
def log_compile_validation(
    compilation_id: str,
    preamble_state: dict[str, Any],
    validation_errors: list[str],
    run_id: str = "pre-fix",
) -> None:
    """No-op hook kept for compile pipeline compatibility."""
    del compilation_id, preamble_state, validation_errors, run_id
